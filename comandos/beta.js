exports.run = (client, message, args) => {
 ...
 (client.guilds.map(guild =>
    ...
    message.channel.send({embed: {
        ...
        color: 0x00000,
        description: `**:floppy_disk:Servidor: __${guild.name}__ |:levitate:Usuários: __${guild.members.size}__ |:notebook_with_decorative_cover:ID: __${guild.id}__| [Link](${a.url})**
